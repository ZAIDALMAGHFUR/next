            ...
            <div className="pt-24">
                <div className="container">
                    <div className="flex flex-wrap lg:justify-between -mx-4">
                        <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                            <div className="max-w-[570px] mb-12 lg:mb-0">
                                <span className="block mb-4 text-base text-teal-500 font-semibold pl-4">
                                    Contact Us
                                </span>
                                <h2
                                    className="
                  ...
                  "
                                ...
                                <p className="text-base text-body-color leading-relaxed mb-9 pl-4">
                                    Ya hallo semuaya jika kalian ingin membuat web kalian bisa
                                    pesan di saya loh!!! , masalah pembuatan cepat kok di jamin, dan bisa saja
                                    tergantung tingkat kesulitan nya.
                                </p>
                     ...
                     "
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">(+62)822 4352 0156</p>
                                    </div>
                                </div>
                                <div className="flex mb-8 max-w-[370px] w-full">
                                    <div
                     ...
                     "
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">almaghfurzaid@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
